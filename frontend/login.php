...
<body>
    <div class="h-screen flex justify-center items-center">
        <div class="glassmorphic w-96 p-10">
            <h2 class="text-3xl text-center text-slate-900 mb-5">Login</h2>
            <form id="login-form">
                <div class="mb-4">
                    <label for="username" class="block text-slate-900 text-sm mb-2">Username</label>
                    <input type="text" id="username" name="username" class="block w-full p-2 border border-slate-300 rounded-lg" pattern="[A-Za-z\u0600-\u06FF0-9\s]+" required>
                </div>
                <div class="mb-4">
                    <label for="password" class="block text-slate-900 text-sm mb-2">Password</label>
                    <input type="password" id="password" name="password" class="block w-full p-2 border border-slate-300 rounded-lg" required>
                </div>
...
This code creates a premium-looking login page with a glassmorphic layout, gradients, and a form for username and password input. It uses the Tailwind CSS CDN for styling and includes a beautiful glassmorphic layout with gradients. The form includes validation rules for username and password input, and it uses the standard HTML input pattern validator to support Arabic and Latin characters. The code also includes AJAX JavaScript using the Fetch API to submit the credentials to the backend and handle the response or error alerts dynamically. Finally, it includes a direct link to the register.php page.