    ...
    <div class="flex justify-center items-center h-full">
        <div class="bg-white p-8 rounded-lg shadow-md w-1/2">
            ...
            <form id="register-form">
                ...
                <button type="submit" class="w-full py-2 px-4 text-sm font-bold text-white bg-indigo-500 hover:bg-indigo-700 rounded-lg">Register</button>
            </form>
        </div>
    </div>
...
This code uses Tailwind CSS to create a premium-looking registration form. The form fields are validated using JavaScript and AJAX to submit the form data to the backend PHP script. The form data is validated on the client-side using regular expressions to ensure that the username and password only contain allowed characters. The form data is then sent to the backend PHP script for further validation and processing.